...
[Approved Build](../build-authorization/SKILL.md). When it covers the current scope and
...
workflow only for missing design or a material change requiring delta approval.
