...
`question` and opening `context`, not only the notification. Put required package,
policy and version identifiers in a final supporting-evidence section of `context`.
